...
?>
    ...
    if (isset($_GET['edit_p_cat'])) {
        ...
        $edit_p_cat_query = "select * from cakecategory where CategoryID='$edit_p_cat_id'";
        $run_edit = mysqli_query($con, $edit_p_cat_query);
        $row_edit = mysqli_fetch_array($run_edit);
        $p_cat_id = $row_edit['CategoryID'];
        $p_cat_title = $row_edit['CategoryTitle'];
        $p_cat_desc = $row_edit['CategoryDesc'];
    }
    ...
    if (isset($_POST['update'])) {
        ...
        $update_p_cat = "update cakecategory set CategoryTitle='$p_cat_title', CategoryDesc='$p_cat_desc' where CategoryID='$p_cat_id'";
